  ...
  _createClass(Group, [
      ...
      value: function updateModelMatrix() {
        ...
        var parentMatrix =
          (this === null || this === void 0
            ...
            ? void 0
            : _this$parent.modelMatrix) || mat4.create();
        mat4.multiply(this.modelMatrix, parentMatrix, this.modelMatrix); // 更新子节点的矩阵
    ...
    },
    {
      ...
      value: function rotate(rotateValues) {
        ...
        mat4.rotateZ(this.rotateMatrix, this.rotateMatrix, rotateValues[2]); // 更新模型矩阵
