...
export default {
  'docs-simple': {
    ...
    previewerProps: {"sources":{"_":{"jsx":rawCode1}},"dependencies":{"react":{"version":"16.14.0"},"@yiqianyao/renderer":{"version":"1.0.0"}},"identifier":"docs-simple"},
  },
  'docs-blend': {
    component: (require('/Users/yiqianyao/workspace/webGL-Three.js-CSS3/renderer/docs/demo/examples/blend.jsx')).default,
    previewerProps: {"sources":{"_":{"jsx":rawCode2}},"dependencies":{"react":{"version":"16.14.0"},"@yiqianyao/renderer":{"version":"1.0.0"}},"identifier":"docs-blend"},
  },
  'docs-box': {
