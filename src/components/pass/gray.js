...
export default class GrayPass {
    constructor(props) {
        ...
        this.framebuffer = glUtils.initFramebuffer(this.gl)
        ...
        this.rectVertices = new Float32Array([ // 将纹理 st/uv 映射到顶点坐标
            -1.0, 1.0,   //左上角
            -1.0, -1.0,  //左下角
            1.0, 1.0,	 //右上角
            1.0, -1.0,   //右下角
        ...
        this.rectUvs = new Float32Array([ // rect uvs
            0.0, 1.0,
            0.0, 0.0,
            1.0, 1.0,
            1.0, 0.0
        ...
        let { buffer: posBuffer, attr: pAttr, count: posCount } = glUtils.bindAttriBuffer(this.gl, 'a_Position', this.rectVertices, 2, this.program)
        this.posBuffer = posBuffer
        this.pAttr = pAttr
        this.posCount = posCount
        let { buffer: texBuffer, attr: tAttr, count: texCount } = glUtils.bindAttriBuffer(this.gl, 'a_TextCoord', this.rectUvs, 2, this.program)
    ...
    drawPass() {
        ...
        this.gl.vertexAttribPointer(this.pAttr, this.posCount, this.gl.FLOAT, false, 0, 0);
